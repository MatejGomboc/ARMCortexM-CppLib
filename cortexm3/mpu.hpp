...
namespace CortexM3::Mpu {
    ...
    union RegionAttributes {
        ...
        struct Bits {
            ...
            uint32_t memory_type: 3; //!< type extension field
    ...
    static inline void setMemoryAttributes(uint32_t idx, bool bufferable, bool cacheable, bool shareable, MemoryType type)
    {
        registers()->region_idx = idx;
        ...
        attr.bits.memory_type = static_cast<uint8_t>(type);
