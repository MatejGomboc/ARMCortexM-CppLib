...
find_program(LLVM_CLANG_PATH clang REQUIRED NO_CMAKE_FIND_ROOT_PATH)
get_filename_component(LLVM_TOOLCHAIN_DIR "${LLVM_CLANG_PATH}" DIRECTORY)
...
# Set the target triple for ARM bare-metal
...
execute_process(COMMAND ${CMAKE_C_COMPILER} --target=${ARM_TARGET_TRIPLE} -print-sysroot OUTPUT_VARIABLE LLVM_TOOLCHAIN_SYSROOT OUTPUT_STRIP_TRAILING_WHITESPACE)
...
set(CMAKE_SYSROOT "${LLVM_TOOLCHAIN_SYSROOT}")
set(CMAKE_FIND_ROOT_PATH "${LLVM_TOOLCHAIN_DIR}")
