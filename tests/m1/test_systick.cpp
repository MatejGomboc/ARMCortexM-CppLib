...
extern "C" [[gnu::naked]] void test_read_ctrl() {
    auto ctrl = ArmCortex::M1::SysTick::CTRL(ArmCortex::M1::SYS_TICK->CTRL);
    (void)ctrl;
}
...
extern "C" [[gnu::naked]] void test_write_ctrl() {
    ArmCortex::M1::SysTick::CTRL ctrl;
    ctrl.bits.ENABLE = 1;
    ctrl.bits.TICKINT = 1;
    ctrl.bits.CLKSOURCE = 1;
    ArmCortex::M1::SYS_TICK->CTRL = ctrl.value;
}
...
extern "C" [[gnu::naked]] void test_read_load() {
    uint32_t load = ArmCortex::M1::SYS_TICK->LOAD;
    (void)load;
}
...
extern "C" [[gnu::naked]] void test_write_load() {
    ArmCortex::M1::SYS_TICK->LOAD = 0xFFFFFF;
}
...
extern "C" [[gnu::naked]] void test_read_val() {
    uint32_t val = ArmCortex::M1::SYS_TICK->VAL;
    (void)val;
}
...
extern "C" [[gnu::naked]] void test_read_calib() {
    auto calib = ArmCortex::M1::SysTick::CALIB(ArmCortex::M1::SYS_TICK->CALIB);
    (void)calib;
}
...
extern "C" [[gnu::naked]] void test_enable_systick() {
    ArmCortex::M1::SysTick::CTRL ctrl;
    ctrl.bits.ENABLE = 1;
    ctrl.bits.CLKSOURCE = static_cast<uint32_t>(ArmCortex::M1::SysTick::CTRL::CLKSOURCE::CPU);
    ArmCortex::M1::SYS_TICK->CTRL = ctrl.value;
}
