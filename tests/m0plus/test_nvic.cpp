...
extern "C" [[gnu::naked]] void test_is_irq_enabled() {
    bool enabled = ArmCortex::M0Plus::Nvic::isIrqEnabled(5);
    (void)enabled;
}
...
extern "C" [[gnu::naked]] void test_enable_irq() {
    ArmCortex::M0Plus::Nvic::enableIrq(10);
}
...
extern "C" [[gnu::naked]] void test_disable_irq() {
    ArmCortex::M0Plus::Nvic::disableIrq(7);
}
...
extern "C" [[gnu::naked]] void test_is_irq_pending() {
    bool pending = ArmCortex::M0Plus::Nvic::isIrqPending(3);
    (void)pending;
}
...
extern "C" [[gnu::naked]] void test_set_pending_irq() {
    ArmCortex::M0Plus::Nvic::setPendingIrq(12);
}
...
extern "C" [[gnu::naked]] void test_clear_pending_irq() {
    ArmCortex::M0Plus::Nvic::clearPendingIrq(15);
}
