...
extern "C" [[gnu::naked]] void test_read_load() {
    uint32_t load = ArmCortex::M0Plus::SYS_TICK->LOAD;
    (void)load;
}
...
extern "C" [[gnu::naked]] void test_write_load() {
    ArmCortex::M0Plus::SYS_TICK->LOAD = 0xFFFFFF;
}
...
extern "C" [[gnu::naked]] void test_read_val() {
    uint32_t val = ArmCortex::M0Plus::SYS_TICK->VAL;
    (void)val;
}
...
extern "C" [[gnu::naked]] void test_write_val() {
    ArmCortex::M0Plus::SYS_TICK->VAL = 0;
}
