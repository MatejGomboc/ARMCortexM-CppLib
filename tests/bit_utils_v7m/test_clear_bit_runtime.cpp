...
// CHECK-NEXT: and.w r0, r0, #254 @ 0xfe
// CHECK-EMPTY:
...
// CHECK-NEXT: and.w r0, r0, #247 @ 0xf7
// CHECK-EMPTY:
...
// CHECK-NEXT: and.w r0, r0, #127 @ 0x7f
// CHECK-EMPTY:
...
// CHECK-NEXT: bic.w r0, r0, #128 @ 0x80
// CHECK-EMPTY:
...
// CHECK-NEXT: bic.w r0, r0, #32768 @ 0x8000
// CHECK-EMPTY:
...
// CHECK-NEXT: bic.w r0, r0, #2147483648 @ 0x80000000
// CHECK-EMPTY:
...
// CHECK-NEXT: bic.w r1, r1, #2147483648 @ 0x80000000
// CHECK-EMPTY:
