...
extern "C" [[gnu::naked]] void test_read_cpuid() {
    auto cpuid = ArmCortex::M0::Scb::CPUID(Cortex::M0::SCB->CPUID);
    (void)cpuid;
}
...
extern "C" [[gnu::naked]] void test_read_icsr() {
    auto icsr = ArmCortex::M0::Scb::ICSR(Cortex::M0::SCB->ICSR);
    (void)icsr;
}
...
extern "C" [[gnu::naked]] void test_read_aircr() {
    auto aircr = ArmCortex::M0::Scb::AIRCR(Cortex::M0::SCB->AIRCR);
    (void)aircr;
}
...
extern "C" [[gnu::naked]] void test_read_scr() {
    auto scr = ArmCortex::M0::Scb::SCR(Cortex::M0::SCB->SCR);
    (void)scr;
}
...
extern "C" [[gnu::naked]] void test_read_ccr() {
    auto ccr = ArmCortex::M0::Scb::CCR(Cortex::M0::SCB->CCR);
    (void)ccr;
}
...
extern "C" [[gnu::naked]] void test_read_shpr2() {
    auto shpr2 = ArmCortex::M0::Scb::SHPR2(Cortex::M0::SCB->SHPR2);
    (void)shpr2;
}
...
extern "C" [[gnu::naked]] void test_read_shpr3() {
    auto shpr3 = ArmCortex::M0::Scb::SHPR3(Cortex::M0::SCB->SHPR3);
    (void)shpr3;
}
...
extern "C" [[gnu::naked]] void test_read_shcsr() {
    auto shcsr = ArmCortex::M0::Scb::SHCSR(Cortex::M0::SCB->SHCSR);
    (void)shcsr;
}
